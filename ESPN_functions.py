...
several_dates(datelist,'corners_append.csv')
'''
datelist=(20151002,20151003,20151004,20151005,20151006)
several_dates(datelist,'corners_append.csv')
'''
several_dates(datelist,'corners_append.csv')
datelist=(20151001,20151002,20151003,20151004,20151005,20151006,20151007,20151008,20151009,20151010,20151011,20151012,20151013,20151014,20151015,20151016,20151017,20151018,20151019,20151020,20151021,20151022,20151023,20151024,20151025,20151026,20151027,20151028,20151029,20151030,20151031)
several_dates(datelist,'corners_append.csv')
